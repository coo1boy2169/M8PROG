...
<?php if(get_theme_mod('fresh_bakers_site_loader',false)!= ''){ ?>
    <?php if(get_theme_mod( 'fresh_bakers_preloader_type','four-way-loader') == 'four-way-loader'){ ?>
	    <div class="cssloader">
	    	<div class="sh1"></div>
	    	<div class="sh2"></div>
	    	<h1 class="lt"><?php esc_html_e( 'loading',  'fresh-bakers' ); ?></h1>
	    </div>
    <?php }else if(get_theme_mod( 'fresh_bakers_preloader_type') == 'cube-loader') {?>
		<div class="cssloader">
...
<div class="<?php if( get_theme_mod( 'fresh_bakers_sticky_header', false) != '') { ?>sticky-header<?php } else { ?>close-sticky main-menus<?php } ?>">
	<header id="site-navigation">
		...
		<div class="header-outter">
			<div class="container">
				<div class="row">
					<div class="col-lg-5 col-md-12 menu-box align-self-center">
