          ...
          foreach ($fresh_bakers_archive_element_sortable as $key => $value) {
            if($value === 'option1') { ?>
              <div class="post-meta my-3">
                ...
                <span class="ms-3"><i class="far fa-comments me-2"></i> <?php comments_number(esc_html__( '0', 'fresh-bakers' ),esc_html__( '1', 'fresh-bakers' ),esc_html__( '%', 'fresh-bakers' ));?><?php esc_html_e( 'comments', 'fresh-bakers' ); ?>
                </span>
              </div>
            <?php }
            if($value === 'option2') { ?>
